...
Shader::Shader(const GLchar *vertexPath, const GLchar *fragmentPath, EShader type)
    :   mType(type)
{
...
void Shader::uniform2f(const std::string &name, const QVector2D &values)
{
...
void Shader::uniform3f(const std::string &name, const QVector3D &values)
{
